...
def send_fix_message(fix_msg: str, tag11: str, msg_type: str) -> str:
    fix_msg_sod = fix_msg.replace(FIELD_DELIMITER, '')
...
def run_test(input_file: str):
    ...
    with open(input_file, newline="") as csvfile:
        ...
        for row in reader:
            ...
            base_cases = expand_test_cases(row)
            ...
            for case in final_cases:
                ...
                received_tags = parse_fix(received_msg, delimiter='') if received_msg else {}
                ...
                result_rows.append({
                    ...
                    "ReceivedFixMessage": received_msg.replace('', FIELD_DELIMITER) if received_msg else ""
                })
