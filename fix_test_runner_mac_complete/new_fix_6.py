        ...
        for row in reader:
            ...
            for case in base_cases:
                ...
                if second_35_value:
                    ...
                    g_case["tag11"] = f"{case['TestCaseID']}_{uuid.uuid4().hex[:4]}"
            ...
            for idx, case in enumerate(final_cases, start=1):
                ...
                print(f"[{idx}/{len(final_cases)}] Running TestCaseID: {testcase_id}, MessageType: {message_type} ...", end=" ")
                ...
                received_msg = send_fix_message(updated_fix, tag11, message_type)
